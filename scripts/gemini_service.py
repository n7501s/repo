...
def generate_response(contents_history):
    ...
    Ако в рамките на разговора се вземе решение за добавяне на идеи, завършване на задачи или отхвърляне, 
    в края на своя отговор задължително добави скрит блок в следния формат (използвай списък items):
    [README_UPDATE]
    {"action": "add_idea", "items": ["Първа идея тук", "Втора идея тук"]}
    [/README_UPDATE]
